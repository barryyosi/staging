...
export function startServer({
  ...
  if (config.pullRequestProvider && !PROVIDERS[config.pullRequestProvider]) {
    console.warn(
  ...
  app.get('/api/pull-request', async (c) => {
    ...
    try {
      ...
      return c.json({ enabled: true, pullRequest });
    } catch (err) {
      return c.json({ enabled: true, pullRequest: null, error: err.message });
    }
  });
