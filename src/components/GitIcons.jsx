...
export const PushIcon = ({ size = 16, className = '', ...props }) => (
  <CloudUpload size={size} className={className} strokeWidth={2.5} {...props} />
);
...
export const GitHubIcon = ({ size = 14, className = '', ...props }) => (
  <Github size={size} className={className} strokeWidth={2.5} {...props} />
);

export const GitLabIcon = ({ size = 14, className = '', ...props }) => (
  <Gitlab size={size} className={className} strokeWidth={2.5} {...props} />
);
